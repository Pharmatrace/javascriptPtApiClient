...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PharmaTraceSupplyChainInformationNetworkApi.LocationsApi();
  });
  ...
  describe('LocationsApi', function() {
    ...
    describe('findLocationById', function() {
      it('should call findLocationById successfully', function(done) {
        //uncomment below and update the code to test findLocationById
        //instance.findLocationById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('findLocations', function() {
      it('should call findLocations successfully', function(done) {
        //uncomment below and update the code to test findLocations
        //instance.findLocations(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
