...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PharmaTraceSupplyChainInformationNetworkApi.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new PharmaTraceSupplyChainInformationNetworkApi.Error();
      //expect(instance).to.be.a(PharmaTraceSupplyChainInformationNetworkApi.Error);
    });
