...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PharmaTraceSupplyChainInformationNetworkApi.Trade();
  });
  ...
  describe('Trade', function() {
    it('should create an instance of Trade', function() {
      ...
      //var instance = new PharmaTraceSupplyChainInformationNetworkApi.Trade();
      //expect(instance).to.be.a(PharmaTraceSupplyChainInformationNetworkApi.Trade);
    });
