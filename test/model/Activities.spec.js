...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PharmaTraceSupplyChainInformationNetworkApi.Activities();
  });
  ...
  describe('Activities', function() {
    it('should create an instance of Activities', function() {
      ...
      //var instance = new PharmaTraceSupplyChainInformationNetworkApi.Activities();
      //expect(instance).to.be.a(PharmaTraceSupplyChainInformationNetworkApi.Activities);
    });
