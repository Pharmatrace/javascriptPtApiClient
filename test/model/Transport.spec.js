...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PharmaTraceSupplyChainInformationNetworkApi.Transport();
  });
  ...
  describe('Transport', function() {
    it('should create an instance of Transport', function() {
      ...
      //var instance = new PharmaTraceSupplyChainInformationNetworkApi.Transport();
      //expect(instance).to.be.a(PharmaTraceSupplyChainInformationNetworkApi.Transport);
    });
