...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PharmaTraceSupplyChainInformationNetworkApi.Activity();
  });
  ...
  describe('Activity', function() {
    it('should create an instance of Activity', function() {
      ...
      //var instance = new PharmaTraceSupplyChainInformationNetworkApi.Activity();
      //expect(instance).to.be.a(PharmaTraceSupplyChainInformationNetworkApi.Activity);
    });
