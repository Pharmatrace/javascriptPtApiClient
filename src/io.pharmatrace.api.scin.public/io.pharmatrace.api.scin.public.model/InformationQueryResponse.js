...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PharmaTraceSupplyChainInformationNetworkApi.InformationQueryResponse = factory(root.PharmaTraceSupplyChainInformationNetworkApi.ApiClient, root.PharmaTraceSupplyChainInformationNetworkApi.Transaction);
  }
  ...
  /**
   * The InformationQueryResponse model module.
   * @module io.pharmatrace.api.scin.public/io.pharmatrace.api.scin.public.model/InformationQueryResponse
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InformationQueryResponse</code>.
   * @alias module:io.pharmatrace.api.scin.public/io.pharmatrace.api.scin.public.model/InformationQueryResponse
   * @class
  ...
  /**
   * Constructs a <code>InformationQueryResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:io.pharmatrace.api.scin.public/io.pharmatrace.api.scin.public.model/InformationQueryResponse} obj Optional instance to populate.
   * @return {module:io.pharmatrace.api.scin.public/io.pharmatrace.api.scin.public.model/InformationQueryResponse} The populated <code>InformationQueryResponse</code> instance.
   */
