...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PharmaTraceSupplyChainInformationNetworkApi.InformationQuery = factory(root.PharmaTraceSupplyChainInformationNetworkApi.ApiClient, root.PharmaTraceSupplyChainInformationNetworkApi.Transaction);
  }
  ...
  /**
   * The InformationQuery model module.
   * @module io.pharmatrace.api.scin.public/io.pharmatrace.api.scin.public.model/InformationQuery
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InformationQuery</code>.
   * @alias module:io.pharmatrace.api.scin.public/io.pharmatrace.api.scin.public.model/InformationQuery
   * @class
  ...
  /**
   * Constructs a <code>InformationQuery</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:io.pharmatrace.api.scin.public/io.pharmatrace.api.scin.public.model/InformationQuery} obj Optional instance to populate.
   * @return {module:io.pharmatrace.api.scin.public/io.pharmatrace.api.scin.public.model/InformationQuery} The populated <code>InformationQuery</code> instance.
   */
