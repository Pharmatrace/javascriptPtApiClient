...
(function(root, factory) {
   ...
   * @module model/InformationQuery
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InformationQuery</code>.
   * @alias module:model/InformationQuery
   * @class
   ...
   * @param {module:model/InformationQuery} obj Optional instance to populate.
   * @return {module:model/InformationQuery} The populated <code>InformationQuery</code> instance.
   */
