...
(function(root, factory) {
   ...
   * @module model/Pharmaceutical
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Pharmaceutical</code>.
   * @alias module:model/Pharmaceutical
   * @class
   */
   ...
   * @param {module:model/Pharmaceutical} obj Optional instance to populate.
   * @return {module:model/Pharmaceutical} The populated <code>Pharmaceutical</code> instance.
   */
