...
(function(root, factory) {
   ...
   * @module model/InformationQueryResponse
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InformationQueryResponse</code>.
   * @alias module:model/InformationQueryResponse
   * @class
   ...
   * @param {module:model/InformationQueryResponse} obj Optional instance to populate.
   * @return {module:model/InformationQueryResponse} The populated <code>InformationQueryResponse</code> instance.
   */
